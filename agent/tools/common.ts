    ...
    jsonTool(
      {
        ...
        description:
          "اعرض مواعيد عمل الطبيب: أيام الأسبوع وساعاته والفرع الذي يداوم فيه كل يوم. استعملها للإجابة عن «هل يعمل الطبيب في فرع كذا؟» أو «في أي فرع يوم كذا؟»، وقبل get_doctor_availability.",
